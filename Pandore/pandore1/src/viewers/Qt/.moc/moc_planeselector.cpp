...
struct qt_meta_stringdata_PlaneSelector_t {
    QByteArrayData data[5];
    char stringdata0[46];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PlaneSelector_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PlaneSelector_t qt_meta_stringdata_PlaneSelector = {
    {
QT_MOC_LITERAL(0, 0, 13), // "PlaneSelector"
QT_MOC_LITERAL(1, 14, 8), // "addFocus"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 13), // "updateNbPlane"
QT_MOC_LITERAL(4, 38, 7) // "nbPlane"

    },
    "PlaneSelector\0addFocus\0\0updateNbPlane\0"
    "nbPlane"
};
...
void PlaneSelector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PlaneSelector *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject PlaneSelector::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_PlaneSelector.data,
    qt_meta_data_PlaneSelector,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *PlaneSelector::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PlaneSelector.stringdata0))
